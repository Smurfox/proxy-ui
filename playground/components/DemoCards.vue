<template>
  <div class="col-span-1 p-8 w-full flex flex-col items-start gap-8">
    ...
    <div class="grid grid-cols-2 gap-6 w-full">
      ...
      <PUCard
        :is-bordered="false"
        custom-class="w-full min-h-70 bg-emerald-400 p-6 flex flex-col justify-between gap-3"
      >
        <div class="flex flex-col gap-3">
          <h2 class="text-xs uppercase font-semibold opacity-40">Strategy</h2>
        ...
        >
          ...
          <PUButton
            ...
            icon-size="25"
            custom-class="bg-black text-white hover:brightness-110"
          />
        </div>
      </PUCard>
      <PUCard
        shadow="md"
        :is-bordered="false"
        custom-class="relative h-95 w-full bg-white flex flex-col justify-end h-full"
      >
        <img
          alt="Product image"
        ...
        <div class="p-3 flex flex-col gap-2 z-10 text-white">
          ...
          <p class="text-sm opacity-90">
            ...
            unforgettable memories with our travel services.
          </p>
        </div>
      </PUCard>
      <PUCard
        custom-class="min-h-100 w-full bg-gradient-to-r from-cyan-500 to-blue-500 flex flex-col justify-end p-5"
      >
        <h1
        ...
        <PUCard
          :is-bordered="false"
          custom-class="mt-2 h-100 w-full bg-white/60 backdrop-blur-2xl flex flex-col gap-4 border border-white/60 backdrop-saturate-150 before:absolute before:inset-0 before:rounded-2xl before:bg-gradient-to-br before:from-white/40 before:to-white/0 before:pointer-events-none"
        >
          <PUCard
            shadow="none"
            :is-bordered="false"
            custom-class="relative mt-2 h-40 w-full bg-white/50 flex flex-col justify-end border border-white/90 overflow-hidden"
          >
            <div
          ...
          <div class="px-2 flex flex-col gap-3">
            ...
            <div class="flex items-center gap-3">
              ...
              />
              <p class="text-sm opacity-60">
                Your friend registers using your link and completes a purchase.
              </p>
            </div>
          </div>
        </PUCard>
